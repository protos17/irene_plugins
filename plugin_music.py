...
def start(core: VACore):
    manifest = {
        ...
        "url": "https://github.com/janvarev/Irene-Voice-Assistant/tree/main/plugins/irene_plugin_music_vlc",
        ...
        "commands": {
            ...
            "пауза|останови музыку|стоп музыка": pause_music,
            "следующий трек|next track|next": next_track,
            "предыдущий трек|previous track|previous": previous_track,
